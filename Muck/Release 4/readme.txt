...
(/spawn) spawns a mob without a boss type on you
(/spawnboss) spawns a mob with a boss type on you (red skull above it)
Usage: /spawn (id)
Usage: /spawn (name)
Usage: /spawnboss (id)
Usage: /spawnboss (name)
Check bottom of text file for available IDs.
Available names to spawn:
"Chunk" ->     Big Chunk
"Bigchunk" ->  Big Chunk
"Big Chunk" -> Big Chunk
"Gronk" ->     Gronk
...
15: Woodman
16: Chief
(anything above or below does nothing)
